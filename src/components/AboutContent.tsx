...
const AboutContent: React.FC = () => {
  return (
    <div>
      ...
      <div className="bg-slate-50 dark:bg-slate-900/20 p-5 rounded-xl border border-slate-200 dark:border-slate-800 mb-5">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-center gap-3 pt-2">
            <a
              ...
              rel="noopener noreferrer"
              aria-label="GitHub"
              className="w-8 h-8 rounded-full bg-blue-600 dark:bg-slate-700 hover:bg-slate-700 dark:hover:bg-blue-600 transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold rounded-full shadow-sm transition-colors"
            >
              Portfolio
            </a>
          </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            ...
            <FeatureCard
              tone="fuchsia"
              icon={<ArrowPathIcon className="w-6 h-6 text-blue-600 dark:text-blue-400" />}
...
const TONES: Record<string, string> = {
  violet: 'bg-slate-50 dark:bg-slate-900/20 border-slate-200 dark:border-slate-800',
