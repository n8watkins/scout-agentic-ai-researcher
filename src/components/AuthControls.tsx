...
/**
 * Sign-in / sign-out control. Renders nothing unless GitHub OAuth is actually
 * configured on the server (detected via /api/auth/providers), so the app stays
 * cleanly local-first when auth isn't set up.
 */
